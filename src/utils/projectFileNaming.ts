export type ProjectFileExtension = ".sptb" | ".spgh" | ".spf" | ".sprp" | ".json";

export type ProjectDocumentKind = "table" | "graph" | "fitYByX" | "tabulate" | "report" | "snapshot";
...
const KNOWN_EXTENSIONS: ProjectFileExtension[] = [".sptb", ".spgh", ".spf", ".sprp", ".json"];
